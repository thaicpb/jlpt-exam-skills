...
3. Hiển thị thẻ trực tiếp nếu ứng dụng hỗ trợ. Mặt trước chỉ có mục từ; khi lật, tách khu vực từ đang học, nhóm cách đọc/ý nghĩa và khung câu mẫu. Câu Nhật có furigana bằng ruby ở trên mọi kanji trừ từ đang học (kể cả dạng biến hình được đánh dấu `target: true`); từ đang học được nhấn màu. Bản dịch Việt nằm ngay dưới câu Nhật. Nguồn nằm trong mục thu gọn. Chữ Nhật lớn, khoảng dòng đủ cho ruby, độ tương phản rõ và nút dễ bấm trên điện thoại.
4. Lật thẻ bằng hiệu ứng xoay 3D hai chiều; đổi nội dung khi thẻ nghiêng 90 độ để không lộ chữ ngược. Chặn thao tác chồng nhau trong lúc lật, giữ focus trên nút lật và bỏ animation khi người dùng bật `prefers-reduced-motion`. Cho lật về mặt trước, xem thẻ trước/sau và đánh dấu “Cần xem lại”. Đây là dấu trang do người học chọn, không phải kết luận đã nhớ hay điểm số. Cho ôn riêng các thẻ đã đánh dấu.
